...
class Raw_Train_Data_Validation:
    ...
    def values_from_schema(self):
        ...
        try:
            ...
            self.log_writer.log(
                log_file=self.train_schema_log, log_file,message,
            )
    ...
    def get_regex_pattern(self):
        ...
        try:
            ...
            self.log_writer.log(
                log_file=self.train_gen_log, log_file,f"Got {regex} pattern",
            )
    ...
    def validate_raw_file_name(
        ...
        try:
            ...
            self.log_writer.log(
                log_file=self.train_name_valid_log,
                log_file,"Got training files with absolute file name",
            )
