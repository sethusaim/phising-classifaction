...
class Train_Validation:
    ...
    def training_validation(self):
        ...
        try:
            ...
            self.log_writer.log(
                self.train_main_log, log_file, "Raw Data Validation Completed !!",
            )

            self.log_writer.log(
                self.train_main_log, log_file, "Starting Data Transformation",
            )

            self.data_transform.add_quotes_to_string()

            self.log_writer.log(
                self.train_main_log, log_file, "Data Transformation completed !!",
            )
